...
<div class="parallax section homehero" data-stellar-background-ratio="0.5" style="background-image:url('upload/demo.jpg');">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <div class="home-message">
                    <h1>A Powerful <span class="element"></span><br>Website Template</h1>
...
<div class="section lb">
    <div class="container">
        ...
        <div class="row freelancer-list">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="freelancer-wrap row-fluid clearfix">
                    <div class="col-md-3 text-center">
                        <div class="post-media">
                            <img class="img-responsive" src="upload/testi_07.png" alt="">
                        </div>
                    </div><!-- end col -->
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="freelancer-wrap row-fluid clearfix">
                    <div class="col-md-3 text-center">
                        <div class="post-media">
                            <img class="img-responsive" src="upload/testi_06.png" alt="">
                        </div>
                    </div><!-- end col -->
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="freelancer-wrap row-fluid clearfix">
                    <div class="col-md-3 text-center">
                        <div class="post-media">
                            <img class="img-responsive" src="upload/testi_04.png" alt="">
                        </div>
                    </div><!-- end col -->
        ...
        <div class="loadmorebutton margintop text-center clearfix">
            <a href="#" class="btn btn-default">View All Freelancers</a>
        </div><!-- end loadmore -->
    </div><!-- end container -->
</div><!-- end section -->
